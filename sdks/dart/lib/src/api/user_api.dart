...
class UserApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DtoMeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DtoMeResponse>> userMeGet({ 
    ...
    DtoMeResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DtoMeResponse),
      ) as DtoMeResponse;
  ...
  /// Returns a [Future] containing a [Response] with a [DtoMeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DtoMeResponse>> userPut({ 
    required DtoUpdateUserRequest request,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DtoUpdateUserRequest);
