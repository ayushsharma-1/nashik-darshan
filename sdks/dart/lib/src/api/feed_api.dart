...
class FeedApi {
  ...
  ///
  /// Parameters:
  /// * [request] - Feed request with sections
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [DtoFeedResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DtoFeedResponse>> feedPost({ 
    required DtoFeedRequest request,
    ...
    try {
      const _type = FullType(DtoFeedRequest);
    ...
    DtoFeedResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DtoFeedResponse),
      ) as DtoFeedResponse;
    ...
    return Response<DtoFeedResponse>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> placesIdViewPost({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/places/{id}/view'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
